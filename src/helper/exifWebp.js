...
ff.setFfmpegPath(ffmpegPath.path);
 ...
 async function imageToWebp (media) {
     ...
     const tmpFileIn = path.join("./", `${Crypto.randomBytes(6).readUIntLE(0, 6).toString(36)}.jpg`)
 ...
 async function videoToWebp (media) {
     ...
     const tmpFileOut = path.join("./", `${Crypto.randomBytes(6).readUIntLE(0, 6).toString(36)}.webp`)
     const tmpFileIn = path.join("./", `${Crypto.randomBytes(6).readUIntLE(0, 6).toString(36)}.mp4`)
